...
#let test(eq, block: true) = {
  ...
  if not block {
    html.elem("span", attrs: (style: "text-align: center; display: inline-block; width: 90%"), try-to-mathml(
      block: block,
      eq,
    ))
    linebreak()
...
#test(
  $mat(
    augment: #(vline: (-2, 2, 1), hline: (1, -1), stroke: 0.1em),
    11, 12, 13, 14, 15;
    21, 22, 23, 24, 25;
    31, 32, 33, 34, 35;
    41, 42, 43, 44, 45;
